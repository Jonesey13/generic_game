...
pub struct CollPoly {
    ...
    pub coll_results: CollResults<super::CollisionTestObject>,
    pub prev: Option<Box<CollRect>>,
    pub player_controlled: bool
}

impl Clone for CollPoly {
    fn clone(&self) -> Self {
        CollRect {
            length: self.length,
            height: self.height,
...
impl Collidable for CollPoly {
    type Data = super::CollisionTestObject;
    ...
    fn get_collision_data(&self) -> Self::Data { super::CollisionTestObject::Rect }
}
